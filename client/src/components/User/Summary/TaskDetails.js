...
/**
 *  <div id="task-details" className={classes.paper}>
            ...
            <div className={classes.detailBody}>
              <div className={classes.eachDetail}>
                ...
                <Typography className={classes.labelData}>{message}</Typography>
              </div>
              <div className={classes.eachDetail}>
                <Typography className={classes.label}>
                  Task Description:
                </Typography>
                <Typography className={classes.labelData}>
                  {taskDescription.length > 0 ? taskDescription : "N/A"}
                </Typography>
              </div>
              <div className={classes.eachDetail}>
                <Typography className={classes.label}>
